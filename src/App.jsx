...
// Componente placeholder para as páginas que ainda vamos criar
const EmBreve = ({ title }) => (
    ...
    <Router>
      <div className="font-sans text-slate-800 bg-slate-50 min-h-screen flex flex-col">
        ...
        <Routes>
          ...
          {/* Páginas que você pode criar depois */}
          <Route path="/sobre" element={<EmBreve title="Sobre o Escritório" />} />
          <Route path="/contato" element={<EmBreve title="Entre em Contato" />} />
        </Routes>

        <Footer />
        
        {/* WhatsApp Flutuante Fixo em todas as telas */}
